    ...
    return (
        <PageFadeIn>
            ...
            <Ribbon light={false} header="Vores indspilninger">
                <FadeInWhenVisible direction="left">
                    <p>Vi har indtil videre udgivet fire indspilninger, som kan høres på alle større streamingtjenester. Musik af Mulden er desuden udgivet som fysisk cd. Du kan læse mere om indspilninger under <a className={styles.textLink} href="/koncerter">koncertprojekter</a>.</p>
                    <Row>
                        <Col xs={12} sm={6}>
